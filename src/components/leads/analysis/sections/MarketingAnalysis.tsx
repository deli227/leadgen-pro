    ...
    >
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-primary-light/70">Score SEO</span>
        </div>

        <div>
          <span className="text-sm font-medium text-primary-light">Stratégie de contenu :</span>
          <p className="text-sm text-primary-light/70">{analysis.content_strategy}</p>
        </div>
        
        <div>
          <span className="text-sm font-medium text-primary-light">Présence sur les réseaux sociaux :</span>
          <p className="text-sm text-primary-light/70">{analysis.social_media_presence}</p>
        </div>
        
        <div>
          <span className="text-sm font-medium text-primary-light">Stratégie de marque :</span>
          <p className="text-sm text-primary-light/70">{analysis.brand_strategy}</p>
        </div>
        
        <div>
          <span className="text-sm font-medium text-primary-light">Positionnement marketing :</span>
          <p className="text-sm text-primary-light/70">{analysis.market_positioning}</p>
        </div>
      </div>
    </motion.div>
  )
