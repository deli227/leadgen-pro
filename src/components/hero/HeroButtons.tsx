  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-xl mx-auto px-4 mt-24">
      ...
      <Button
        ...
        className="w-full sm:w-auto text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 bg-gradient-to-r from-accent/10 via-primary/10 to-accent/10 text-white border-primary-light hover:border-primary hover:from-accent/20 hover:via-primary/20 hover:to-accent/20 shadow-lg hover:shadow-xl transition-all duration-300"
