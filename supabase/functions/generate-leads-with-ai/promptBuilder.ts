...
export function buildPrompt(filters: Filters): string {
  ...
  prompt += `\n\nATTENTION: Tu dois UNIQUEMENT renvoyer un tableau JSON valide avec cette structure exacte, sans AUCUN texte avant ni après:
  [
    {
  ...
  Ne renvoie RIEN d'autre que le tableau JSON. Pas de texte d'introduction, pas d'explication, uniquement le tableau JSON.`;
